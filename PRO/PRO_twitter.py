...
# Colonne da leggere
required_columns = ['author_id', 'post_id']
...
final_dataset[['post_size', 'interaction_len']].to_csv('/home/jacoponudo/Documents/Size_effects/DATA/twitter/PRO_twitter.csv', index=False)
