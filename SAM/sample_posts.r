...
sampled_post_ids <- sample(unique(all_comments$post_id), size = 1000000, replace = FALSE)
...
output_file <- "~/Documents/Size_effects/DATA/facebook/facebook_raw_data.parquet"
